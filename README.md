...
Монтируют **Windows (WinFsp) и Linux (FUSE)**; macOS ждёт macFUSE, и там
кнопка честно заблокирована с указанием причины.
...
| M6 | Адаптер FUSE (Linux) | готово: 27/27 приёмки на томе в Linux |
...
284 теста плюс приёмка на живом томе — на обеих платформах:
...
26 сценариев против смонтированного диска (27 под Linux) — чтение, поиск, два хендла,
