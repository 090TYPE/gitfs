...
Ядро, виртуальное дерево и все пять вьюх готовы. Ниже — настоящий вывод на
...
| M8 | Релиз: single-file бинарники, winget/scoop | не начат |

## Как устроено

```
Gitfs.Cli            doctor · tree · mount
...
196 тестов. Методика — **дифференциальная**: эталоном служит сам git.
