...
Окно со списком монтирований и диагностикой, диалог с живым превью дерева,
иконка в трее. Один код на Avalonia; монтируют Windows и Linux, на macOS
кнопка заблокирована с указанием причины.

![Приложение под Linux](docs/screenshots/linux-app.png)
...
349 тестов на Windows, 325 на Linux — и приёмка против **смонтированного
диска**, по два прогона на каждой платформе в CI на раннерах GitHub.
