...
трее, где состояние читается формой значка, а не только цветом. Светлая и тёмная темы, по умолчанию — как в системе. Один код на
...
452 теста, одно и то же число на обеих платформах — и приёмка против
